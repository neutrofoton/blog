...
4. Initializing Clustering
   ...
   <img class="center" src="{{ site.baseurl }}/assets/images/post/k8s/vbox/k8s-vbox-all-pods-running.png" alt=""/>
...
kubectl get nodes -o wide
```
   <img class="center" src="{{ site.baseurl }}/assets/images/post/k8s/vbox/k8s-nodes.png" alt=""/>
