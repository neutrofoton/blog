...
<img class="center" src="{{ site.baseurl }}/assets/images/post/k8s/microservice-fleetman.png" alt="" width="75%"/>
...
<img class="center" src="{{ site.baseurl }}/assets/images/post/k8s/active-mq-deploy-svc.png" alt=""/>

Now open in browser <code>http://192.168.59.105:30010/</code>

<img class="center" src="{{ site.baseurl }}/assets/images/post/k8s/active-mq-ui.png" alt="" width="75%"/>

> ActiveMQ default username/password is <code>admin/admin</code>
...
<img class="center" src="{{ site.baseurl }}/assets/images/post/k8s/position-tracker-service.png" alt="" width="75%"/>

When we hit through browser to <code>http://192.168.59.105:30011/</code> we get 404 which means that the position tracker service (spring boot app) run well.
...
<img class="center" src="{{ site.baseurl }}/assets/images/post/k8s/active-mq-queue.png" alt="" width="75%"/>
...
Let's check the API gateway by open <code>http://192.168.59.105:30020/</code> in browser.

<img class="center" src="{{ site.baseurl }}/assets/images/post/k8s/api-gateway-check.png" alt="" width="75%"/>
...
<img class="center" src="{{ site.baseurl }}/assets/images/post/k8s/fleet-man-all.png" alt=""/>

Lastly we can open the app in browser <code>http://192.168.59.105:30080/</code>

<img class="center" src="{{ site.baseurl }}/assets/images/post/k8s/fleet-man-app.png" alt="" width="75%"/>
