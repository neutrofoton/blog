...
<img src="{{ site.baseurl }}/assets/images/post/k8s/service-pod.png" alt=""  width="75%"/>
...
<img src="{{ site.baseurl }}/assets/images/post/k8s/access-app-from-outside.png" alt="" width="75%"/>

Then open browser:
http://192.168.59.100:30080

<img src="{{ site.baseurl }}/assets/images/post/k8s/open-app-0.png" alt="" width="75%"/>
...
<img src="{{ site.baseurl }}/assets/images/post/k8s/service-pod-change-selector.png" alt="" width="75%"/>

We can check further in the detail service information

<img src="{{ site.baseurl }}/assets/images/post/k8s/service-info-change-selector.png" alt="" width="75%"/>
